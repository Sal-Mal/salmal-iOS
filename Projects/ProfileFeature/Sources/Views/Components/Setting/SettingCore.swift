...
public struct SettingCore: Reducer {
  ...
  public struct State: Equatable {
    ...
    var menus: IdentifiedArrayOf<SettingMenu> = [
      ...
      .init(title: "이용약관 및 개인정보 처리 방침", icon: .ic_component, state: .none),
      .init(title: "개발자한테 연락하기", icon: .ic_send, state: .none),
      .init(title: "E-mail 및 SMS 광고성 정보 수신동의", icon: .ic_send, state: .none),
